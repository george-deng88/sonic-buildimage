    ...
    def set_speed(self, speed):
        ...
        if self.is_psu_fan:
            ...
            if speed == 0:
                ...
                bmc_cmd = "ipmitool raw 0x3a 0x06 0x01 0x01"
            else:
                # Disabled FCS auto control mode first
                bmc_cmd = "ipmitool raw 0x3a 0x06 0x01 0x00"
                try:
                    p = os.popen(bmc_cmd)
                    p.close()
                except IOError:
                ...
                bmc_cmd = "ipmitool raw 0x3a 0x06 0x2 0x1 {}".format(hex(speed))
